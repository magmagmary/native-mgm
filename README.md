...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/whd71YaIA1)
...
```sh
npx nx serve native-mgm
```

To create a production bundle:

```sh
npx nx build native-mgm
```

To see all available targets to run for a project, run:

```sh
npx nx show project native-mgm
```
